...
$(BUILT_STAMP):
	$(MAKE) -C $(PKG_ROOT) all $(UC_PATH) \
		...
		KERNEL_VERSION=2.4.23
	touch $(BUILT_STAMP)

install: build
	cp $(PKG_ROOT)/wlan/wlan.o $(ROOTFS)/lib/modules/2.4.23/pcmcia
	cp $(PKG_ROOT)/ath_hal/ath_hal.o $(ROOTFS)/lib/modules/2.4.23/pcmcia
	cp $(PKG_ROOT)/driver/ath_pci.o $(ROOTFS)/lib/modules/2.4.23/pcmcia
